...
-- ============================================
-- This SQL creates the product_ratings table for the rating system
-- 
-- INSTRUCTIONS:
...
DROP POLICY IF EXISTS "Users can delete their own ratings" ON public.product_ratings;
...
-- ============================================
-- That's it! The ratings table is now ready
-- ============================================
